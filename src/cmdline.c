/*
  ...
  /usr/bin/gengetopt --input=options.ggo --unamed-opts --file-name=cmdline --unamed-opts --file-name=cmdline
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -o, --stdout                  Copy the capture image to stdout  (default=off)",
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->stdout_help = gengetopt_args_info_help[26] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "Vsx:y:w:h:g:d:i:m:b:p:t:c:nlo", long_options, &option_index);
